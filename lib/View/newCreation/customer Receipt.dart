...
class Customer_Receipt_Form extends StatefulWidget {
  @override
  _Customer_Receipt_FormState createState() => _Customer_Receipt_FormState();
}

class _Customer_Receipt_FormState extends State<Customer_Receipt_Form> {
